 ...
 */
class PIM_Menu_Walker_Edit extends Walker_Nav_Menu_Edit {
	/**
	 * Start the element output.
	 */
	function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		$item_object =  PIM\PIM_Admin::$item_object;
		parent::start_el( $output, $item, $depth, $args, $id );
		if ($item->object != $item_object) {
			return;
		}
		$custom_fields = PIM\PIM_Admin::$fields;
